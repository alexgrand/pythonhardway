...
print("1 != 0 and 2 == 1 (False) > ", 1 != 0 and 2 == 1)
...
print("not (\"testing\" == \"testing\" and \"Zed\" == \"Cool Guy\") (True) > ", not ("testing" == "testing" and "Zed" == "Cool Guy"))
print("1 == 1 and (not (\"testing\" == 1 or 1 == 0)) (True) > ", 1 == 1 and (not ("testing" == 1 or 1 == 0)))
print('"chunky" == "bacon" and (not (3 == 4 or 3 == 3)) (False) > ', "chunky" == "bacon" and (not (3 == 4 or 3 == 3)))
print('3 == 3 and (not ("testing" == "testing" or "Python" == "Fun")) (False) > ', 3 == 3 and (not ("testing" == "testing" or "Python" == "Fun")))